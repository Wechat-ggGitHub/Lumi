...
- **海外**：Anthropic (Claude)、OpenAI (ChatGPT)、Google (Gemini)
...
https://github.com/Wechat-ggGitHub/Lumi/releases/download/v0.1.0-alpha/Demo1_hq.mp4

https://github.com/Wechat-ggGitHub/Lumi/releases/download/v0.1.0-alpha/Demo2_hq.mp4
