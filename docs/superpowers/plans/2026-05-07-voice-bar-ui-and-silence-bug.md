...
Run: `cd /Users/rikiwang/Documents/Agent/Shrew/Shrew && npx tsc --noEmit -p tsconfig.json`
...
Run: `cd /Users/rikiwang/Documents/Agent/Shrew/Shrew && npx jest src/__tests__/store.test.ts -t "invalid transitions log a warning"`
...
Run: `cd /Users/rikiwang/Documents/Agent/Shrew/Shrew && npx jest src/__tests__/store.test.ts`
...
Run: `cd /Users/rikiwang/Documents/Agent/Shrew/Shrew && npx jest`
Expected: 全部 PASS。
...
logger so future regressions show up in ~/.shrew/logs.
...
Run: `cd /Users/rikiwang/Documents/Agent/Shrew/Shrew && npx tsc --noEmit -p tsconfig.electron.json`
...
Run: `cd /Users/rikiwang/Documents/Agent/Shrew/Shrew && grep -rn "voice:start-recording\|voice:continuous-chat-hint\|showHint" electron src 2>/dev/null | grep -v "\.next/\|dist-electron/"`
Expected: 输出应为空。
...
Run: `cd /Users/rikiwang/Documents/Agent/Shrew/Shrew && npx tsc --noEmit -p tsconfig.json && npx tsc --noEmit -p tsconfig.electron.json && npx jest`
Expected: 全部 PASS。

- [ ] **Step 2: 启动 dev 模式**

Run: `cd /Users/rikiwang/Documents/Agent/Shrew/Shrew && npm run electron:dev`
...
Run: `tail -200 ~/.shrew/logs/shrew-$(date +%Y-%m-%d).log | grep -i "rejected\|error\|warn"`
